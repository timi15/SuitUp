...
A **SuitUp!** egy webalkalmazás, amely lehetővé teszi a felhasználók számára, hogy saját ruhadarabjaikat feltöltsék, és
ezekből különböző **outfiteket** állítsanak össze.  
...
A cél egy olyan platform létrehozása, ahol a felhasználók digitálisan rendszerezhetik ruhatárukat, inspirációt kaphatnak
az összeállításokhoz, és könnyen átláthatják, mely ruhadarabjaikat használják a leggyakrabban.
